export namespace deck {
	...
	export class CreateInput {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.cards = this.convertValues(source["cards"], model.Card);
	    }
	...
	export class UpdateInput {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.id = source["id"];
	        this.name = source["name"];
	        this.curLength = source["curLength"];
	        this.cardsToUpdate = this.convertValues(source["cardsToUpdate"], UpdateCardInput);
	    }
